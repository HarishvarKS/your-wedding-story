      ...
      >
        ...
        <div>
          ...
          <div className="space-y-4 text-sm leading-relaxed text-muted-foreground">
            <p>
              With over half a decade behind the lens, Logesh founded Iraivan Photography
              with a singular vision: to elevate wedding photography into a legacy. Drawing
              from a background in documentary Photography, Logesh brings a rare combination
              of technical precision and emotional intuition to every project.
            </p>
            <p>
              When not capturing love stories across the globe, Logesh can be found teaching
              and mentoring the next generation of visual storytellers
            </p>
          </div>
          <a
            href="/about"
